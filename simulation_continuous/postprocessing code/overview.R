...
gbshared_aipw <- readRDS("res_gbshared_aipw.RDS")
gbnotshared_aipw <- readRDS("res_gbnotshared_aipw.RDS")
nogbnotshared_aipw <- readRDS("res_nogbnotshared_aipw.RDS")
nogbshared_aipw <- readRDS("res_nogbshared_aipw.RDS")
...
saveRDS(results_all, file = "results_all_cts.RDS")
write.csv(results_all, file = "results_all_cts.csv")
