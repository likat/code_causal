...
coef_pencomp <- imputedlist_spline$coeflistres
coef_pencompwfpbb <- imputedlist_wfpbbspline$coeflistres
knotloc_pencomp <- imputedlist_spline$knotlocations
knotloc_pencompwfpbb <- imputedlist_wfpbbspline$knotlocations
# print(paste0("I is ",i))

# }
res <- list(coef_pencomp = coef_pencomp,
            coef_pencompwfpbb = coef_pencompwfpbb,
            knotloc_pencomp = knotloc_pencomp,
            knotloc_pencompwfpbb = knotloc_pencompwfpbb
)
# saveRDS(res, file=paste0("results/results_tingting_", type_outcome, type_overlap, ".RDS"))
saveRDS(res, file = paste0("results-raw-2stage-coefonly/", type_outcome, type_overlap,"/results_tingting_noaiptw", type_outcome, type_overlap,i, ".RDS"))
