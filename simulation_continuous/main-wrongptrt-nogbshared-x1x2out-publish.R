...
# modlin <- cmdstan_model(paste0(pathtocode, "CODE/outcome_mod_normal.stan"))
...
saveRDS(res, file = paste0("results-raw-wrongptrt/results_wrongptrt_x1x2", type_outcome, type_overlap,i,".RDS"))
