...
AIPTW = 
  ...
  #   {
      ...
      ## Note: I don't know what this weight means.
      # summary(weight)
      ...
      mod3_1=lm(modely1, data=data[treatInd==1,] %>% as.data.frame()) 
      mod3_0=lm(modely0, data=data[treatInd==0,]%>% as.data.frame()) 
      mod3_des = lm(modely1, data=data%>% as.data.frame())
      ...
      Gcomp1=gcomputeFunc(final.mod=mod3_1, data=data, des3 = mod3_des,
      ...
      Gcomp0=gcomputeFunc(final.mod=mod3_0, data=data, des3 = mod3_des,
                          baselineVar=baselineVar, numCarlo=numCarlo, 
                          treat.varname=treat.varname, outcome.varname=outcome.varname, 
                          type = "normal",
                          treat=0)
  ...
  for(u in 1:dim(dataInput)[1]) { 
      ...
      res <- list(result = result, 
                  time = as.numeric(t1_aiptw) - as.numeric(t0_aiptw))
      return(res) 
