...
type_y <- "bin"
## CHANGE simulation type here (gb / nogb)
type_outcome = "gb" 
## CHANGE simulation type here (shared / notshared)
...
saveRDS(res, file = paste0("results-raw-2stage-bin/", type_outcome, type_overlap,"/results_tingting_noaiptw", type_outcome, type_overlap,i, ".RDS"))
